...
import { useActiveSectionContext } from "@/context/active-section-header";
    ...
    return (
        <section  ref={ref} className="mb-28 max-w-[50rem] text-center sm:mb-0 scroll-mt-[100rem]" id="home">
            ...
            <motion.h1
                ...
                >
                <span className="font-bold">Hello, I'm Arpit Ojha.</span> I'm a{" "}
                <span className="font-bold">full-stack developer</span> with{" "}
                <span className="font-bold">3 years</span> of experience. I enjoy
                crafting <span className="italic">sites & apps</span>, focusing on{" "}
            ...
            >
                ...
                href="https://www.linkedin.com/in/arpit-ojha-8951031a1/"
                target="_blank"
                >
                <BsLinkedin />
                </a>
                ...
                href="https://github.com/Arpit245"
                target="_blank"
                >
                <FaGithubSquare />
                </a>
